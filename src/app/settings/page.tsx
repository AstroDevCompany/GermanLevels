...
export default function SettingsPage() {
  ...
  const { prefs, setPrefs, clearProgress } = useApp();

  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 sm:px-6">
      <h1 className="text-4xl font-semibold tracking-tight">Settings</h1>
      <p className="mt-3 text-[var(--muted)]">
        Theme follows your system unless you lock it. Other choices stay on this
        device.
      </p>
      ...
      <button
        ...
        onClick={() => {
          if (confirm("Reset all lesson progress on this device?")) clearProgress();
        }}
      >
        Reset progress
      </button>
